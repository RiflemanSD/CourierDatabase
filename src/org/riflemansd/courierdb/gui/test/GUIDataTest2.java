 ...
 * @author RiflemanSD
 */
public class GUIDataTest2 extends javax.swing.JFrame {

    private JXSortableTable table;
    private SearchPanel2 sPanel;
    ...
    public GUIDataTest2() {
        ...
        table = new JXSortableTable("VoucherID,Αντικαταβολή,Χρέωση,Παραλαβή", "s", 1.0, 1.0, true);
...
//        defineData();
    ...
    public String[] rowToString(Object[] objects) {
        //"VoucherID,Αντικαταβολή,Χρέωση,Παραλαβή"
    ...
    public Object[] stringToRow(String[] objects) {
        ...
        datas[0] = objects[0];
        datas[1] = MyUtils.stringToDouble(objects[1]);
        datas[2] = MyUtils.stringToDouble(objects[2]);
        datas[3] = MyUtils.stringToBoolean(objects[3]);

        return datas;
    }

    public void defineData(String voucherID) {
        VoucherS v = CourierDBM.database.getVoucher(voucherID);
...
//        objects[1] = BusinessProfit.database.getDate(ind[6]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIDataTest2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUIDataTest2 test = new GUIDataTest2();
