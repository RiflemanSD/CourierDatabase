 ...
 * @author RiflemanSD
 */
public class GUIDataTest3 extends javax.swing.JFrame {
     ...
     */
    public GUIDataTest3(String columns, Object... columnClasses) {
...
//        defineData();
        ...
        this.rootPane.setDefaultButton(sPanel.searchButton());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIDataTest3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUIDataTest3 test = new GUIDataTest3("VoucherID,Ημερομηνεία,Κατάσταση,Παραλαβή,number", "s", new Date(), "s", true, 1.5);
